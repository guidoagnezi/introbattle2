...
inim8 = Monstro     ("Demonio",  190, 50, 30, 12, wekapipo,  30, 8, 0, 6)
inim9 = Monstro     ("Bombinha", 155, 30, 40, 12, devolver,  30, 5, 3, 6)
inim10 = Monstro    ("Linguico", 150, 30, 45, 18, surra,     35, 4, 7, 6)
inim11 = Monstro    ("Ico",      170, 30, 40, 12, explosao,  40, 5, 7, 6)
inim12 = Monstro    ("Gelo",     150, 35, 35, 12, nevasca,   40, 6, 5, 6)
inim13 = Monstro    ("Xamilo",   160, 35, 50, 18, cortar,    40, 3, 0, 6)
inim14 = Monstro    ("Adiburai", 160, 30, 50, 18, treinar,   40, 4, 6, 6)

inim15 = Monstro    ("Demonio",  250, 55, 35, 18,nevasca,   45, 8, 0, 6)
inim16 = Monstro    ("Bombinha", 220, 40, 50, 12, devolver,  45, 6, 6, 6)
inim17 = Monstro    ("Kamirider",190, 30, 75, 16,surra,     45, 3, 3, 4)
inim18 = Monstro    ("Odiburoi", 210, 30, 60, 14, corre,     55, 7, 6, 4)
inim19 = Monstro    ("Monge",    200, 35, 50, 21,saraivada, 55, 6, 4, 1)
inim20 = Monstro    ("Camboja",  230, 45, 40, 16,eletroterapia,55, 3, 5, 3)
